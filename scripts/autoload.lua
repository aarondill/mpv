...
local function filter_tbl(t, iter)
  for i = #t, 1, -1 do
...
local function get_playlist_filenames(pl_count)
  local filenames = {}
...
local function find_and_add_entries()
  ...
  local append = { [-1] = {}, [1] = {} }
  local filenames = get_playlist_filenames(pl_count)
